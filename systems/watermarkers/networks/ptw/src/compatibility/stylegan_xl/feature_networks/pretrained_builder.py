...
from src.compatibility.stylegan_xl.feature_networks import clip
from src.compatibility.stylegan_xl.feature_networks.vit import (
...
from src.compatibility.stylegan_xl.pg_modules.blocks import Interpolate
...
def _make_pretrained(backbone, verbose=False):
    ...
    pretrained.CHANNELS, pretrained.RES_MULT = calc_dims(
        pretrained, is_vit=backbone in VITS
    )
