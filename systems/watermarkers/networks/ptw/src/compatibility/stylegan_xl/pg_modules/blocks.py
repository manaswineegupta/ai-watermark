...
from src.compatibility.stylegan_xl.training.networks_stylegan2 import (
    Conv2dLayer,
    Conv2dLayerDepthwise,
)
...
class DownBlockSGBlocks(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        conv_depthwise = Conv2dLayerDepthwise(
            in_channels, in_channels, kernel_size=3, activation="linear"
        )
        conv_pointwise = Conv2dLayer(
            in_channels, out_channels, kernel_size=1, activation="lrelu", down=2
        )
