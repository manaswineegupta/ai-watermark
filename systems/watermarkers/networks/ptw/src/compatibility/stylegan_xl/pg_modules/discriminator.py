...
from src.compatibility.stylegan_xl.pg_modules.blocks import (
    conv2d,
    DownBlock,
    DownBlockPatch,
)
from src.compatibility.stylegan_xl.pg_modules.projector import F_RandomProj
from src.compatibility.stylegan_xl.feature_networks.constants import VITS
    ...
    def __init__(
        ...
        **kwargs,
        ...
        for i, (cin, res) in enumerate(zip(self.disc_in_channels, self.disc_in_res)):
            ...
            mini_discs += (
                [str(i), Disc(nc=cin, start_sz=start_sz, end_sz=8, patch=patch)],
            )
...
class ProjectedDiscriminator(torch.nn.Module):
    def __init__(
        self, backbones, diffaug=True, interp224=True, backbone_kwargs={}, **kwargs
    ):
        super().__init__()
    ...
    def forward(self, x, c):
        ...
        for bb_name, feat in self.feature_networks.items():
            ...
            x_aug = (
                lambda x: x
            )  # DiffAugment(x, policy='color,translation,cutout') if self.diffaug else x
